package com.javaoffers.base.aop.cache;
...
import com.javaoffers.base.exception.CacheException;
import com.javaoffers.base.annotation.cache.EnableCache;
import com.javaoffers.base.annotation.cache.UnableCache;
import com.javaoffers.base.definition.CacheData;
import com.javaoffers.base.common.definition.ClassDefinition;
import com.javaoffers.base.common.definition.MethodDefinition;
import com.javaoffers.base.definition.UniqueKey;
import com.javaoffers.base.common.clazz.ClassUtils;
...
public class CacheAspect implements InitializingBean{
	 ...
	 * 启用缓存切点
	 */
	@Pointcut("@annotation(com.javaoffers.base.annotation.cache.EnableCache)")
	 ...
	 * 弃用缓存切点
	 */
	@Pointcut("@annotation(com.javaoffers.base.annotation.cache.UnableCache)")
