package com.javaoffers.base.mq.process;
...
import com.javaoffers.base.mq.exception.MHMQException;
...
public class ScanQueueClazz  {
    ...
    private static final String QUEUE_ANNOTATION_NAME = "com.javaoffers.base.mq.annotation.CreateQueue";
    private static final String LISTENER_QUEUE_ANNOTATION_NAME = "com.javaoffers.base.mq.annotation.ListenerQueue";
	static {
    	try {

			Collection<URL> urls = ScanQueueClazz.forResource(resourceName("com.javaoffers"), ScanQueueClazz.class.getClassLoader());
