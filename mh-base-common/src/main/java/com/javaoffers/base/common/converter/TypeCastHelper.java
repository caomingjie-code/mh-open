package com.javaoffers.base.common.converter;
...
public class TypeCastHelper {
    ...
    public static String toString(Object obj, String defaultValue) {
    	if(obj instanceof Date){
            try {
                String format = DateFormatUtils.format((Date) obj, "yyyy-MM-dd HH:mm:ss");
                return format;
            }catch (Exception e){
            }
        }
    ...
    public static Object ConverterObject(Class clazz,Object obj) {
    	if(clazz.isArray()) {
			String typeName = clazz.getTypeName();
			try {
				Class<?> class2 = Class.forName(typeName.substring(0, typeName.length()-2));
				clazz = class2 ;
			} catch (Exception e) {
				e.printStackTrace();
			}
