package com.javaoffers.base.quartz;
...
import com.javaoffers.base.quartz.task.BaseSimpleTask;
import com.javaoffers.base.quartz.task.BaseStateTask;
...
public class SchedulerUtil {
    ...
    private final static String anno = "com.javaoffers.base.quartz.annotation.BaseQuartz";
    			...
    			//getClassName(f);
    	         ...
    	         if(annotations!=null) {//便利注解
                	 for(AnnotationNode an: annotations) {
                		 ...
                		 if("com.javaoffers.base.quartz.annotation.BaseQuartz".equals(annoName)) {
